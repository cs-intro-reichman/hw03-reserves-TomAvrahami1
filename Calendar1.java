...
public class Calendar1 {	
	...
	static int SundaysCounter = 0; // Counter of Sundays that occured on the first day of the month 
	
	/** 
	 * Prints the calendars of all the years in the 20th centurof Sundays that occured on the first day of the monthy. Also prints the  
